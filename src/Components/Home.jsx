    ...
    <>
      ...
      <section className='section' ref={scrollview} data-aos="zoom-in-down" data-aos-easing='ease-in-out' data-aos-mirror='true'>
         ...
         <div className='resume-in'>
           ...
           <a href="https://logeswaranb.vercel.app/#/contact"><button className='button2' >Contact Me</button></a>
         </div>
     ...
     <div>
        ...
        <div className='section-3'>
          ...
          <a href="https://logeswaranb.vercel.app/#/about"><button>More About Me</button></a>
        </div>
        </div>
